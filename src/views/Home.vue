<template>
  <div class="home">
    <div>
      ...
      <input type="text" placeholder="description" v-model="newProductDescription"><br>
      <input type="text" placeholder="price" v-model="newProductPrice"><br>
      <input type="text" placeholder="image url" v-model="newProductImageUrl"><br>
